...
fn xo(s: &'static str) -> bool {
    let r : (u32, u32) = s.to_lowercase().chars().fold((0,0), |accu, c| {
        if c == 'o' {
            (accu.0+1, accu.1)
        } else {
            if c == 'x' {
...
fn returns_expected() {
    ...
    /* The algorithm used for these randomly generated test cases
    ** is the same as in the C version.
    */
    assert_eq!(xo(" 2CCRFyYGmFDS9PABNyx0kvTU4rbCclaaw6FG9plcB79CRUIlP1k2aBveNZBp08xq17DVr7o11tOxO"), true);
    assert_eq!(xo("Dp639uDloW04O"), false);
    assert_eq!(xo("M28GVA MTIHzPhDizgjgydlHRnoElH iUnXk0aiWHCCg9vckA"), true);
    assert_eq!(xo("YFCVxfsQGEirISQj5nmw1yXAxL9GqUhYs9lEaQ5B301 PlGRFtETiftQ6ey"), false);
    assert_eq!(xo("UlmHgHaniepqeqnSjwt5yTmfHRSARKTe83L"), true);
    assert_eq!(xo("Y1IS4LP4H7E79UNwqdgHFMhoRLoWOMSyGoGY1hmRd3 obhpbQvwysksG8lyYiKSX1hkFTHpG"), false);
    assert_eq!(xo("UC3X5gpghdmRnrWHo9C1ITFNVlkQm578GVKOqMNgwsLbgowcyVsDjBmeyHQ"), false);
    assert_eq!(xo("Pc hoyBo5Ox5Lwk8pzjgyQ1cghvk5CXWioHhdEctqF9LGjDNO4wSl27RujX90WQuOizCIDMIkNg7e"), false);
    assert_eq!(xo("LOKZsqPyWGzdDzDemdpK8GxXsOY EIgsi66k4E"), true);
    assert_eq!(xo("vuHYX8pXvc3wjUzwZ3UicucTfgnWo2MR9EqH onXEjVXNrZU7j"), false);
    assert_eq!(xo("hx8LYsu9k7CZ3gXYS15bzsiw8oLWe0tjk09BoyX wTp2X2bx"), false);
    assert_eq!(xo("kG0 X9b4KM6F2s61oK0fQmd7YrFnn0rGFetb0QjHhplucs6Q35Fkk"), true);
    assert_eq!(xo("gBM1pfBf1Wf3Mdlr1UdoATxY7anIWGxFQpRPxlBpL0wTszYqNLond 3oAkGw50Dcii5QbG"), true);
    assert_eq!(xo("rFIYN2eNFZ5q4c3w5pF6eSIcZDho06KqUhUctUpHgtHibOikHCaHbHetzkfja3kL"), false);
    ...
    assert_eq!(xo("xZgNFB3ZgA78EdWfZMhc6wgaufKck6AODMbhDg9MB5XkyaWV0Ki6Hx"), false);
    ...
    assert_eq!(xo("EwkQlZKogIx6A81ZoSUAREsVVVvQKVbpBSItchdUVRQb kiI2SicykiMrQkLfS20gmr"), false);
    assert_eq!(xo("DfrmKRViZ2FPRZ4U99bwmSXAdOPn0A7SNq0EWZOdAfVr5FP4S63qTPAKastiVqKP9HrQmPA9BcwH0POPEmP8qsFavHhuG7"), false);
    assert_eq!(xo("DSKe0lA9r88K5TgR0Ft7FhIVAhwG58cTUwYYkiWle q86gQ31YNRCbjcPhqWdx8ZzQjIUHNOuNYqw932"), true);
    assert_eq!(xo("KxseIRPNTeqB8Ltm7S5S EKf9Kd5OwvgcUg3eN"), true);
    assert_eq!(xo("TNFjVxxpj5r2lRITWhGvVKL0qgf3gqYKNs8PEhKXpXAQhi6KvPeukLyj"), false);
    ...
    assert_eq!(xo("OGTTKAAUnyr3VXxH388oGkdSC18dgnvVtMkC 1jM7kGLq9v36z9IApax8yRdR"), false);
    assert_eq!(xo("7IGsktwT48VYDXR0PbkO71HtaDaFBSEZao5md55rMFIEmqW0nKYlUdvKNRxAuBzg4sAuyTi6aG"), true);
    assert_eq!(xo("UFVYeRrlwfSKwi0AsV3nGr0ZiEMqDRvouoFuPGnP4wk3ujQhqzAGbAbR"), false);
    ...
    assert_eq!(xo("qVisrEcVfhQSfwaLgyClcw7bIPHTtb5eiegaEO7FNvjwcmKOWW1BWVoqvBTmobQhmGn4flT0FV00pHU"), false);
    assert_eq!(xo("pbcOpEOEge3vmxSM89Hojso46y1eCbP3X6Q2vqcAef8WTUhQT4OXtGD9XQ9"), false);
    assert_eq!(xo("MInUENm1NLQM4vhm5W1bcbibrLzCalh01SRx 2odOU0E4g1CHFp0"), false);
    assert_eq!(xo("jbq0HVp9wuBDPywWfg0Lf O gct3Rt3Lm3GySNeS3BhQ3k2rE1CHhxtEDpvif"), true);
    assert_eq!(xo("NSeEGGjGkoWRUxZncaftMWb46qehuhm5MWbTyDaxXDVk6RHkF4cEzLbdKm BDMKWhe6lHuS KbKS2c2Tdf8T"), false);
    assert_eq!(xo("xHPKucx6eCpyHQZVeiQmNtgo6KxuFNq7RIFP59E5KS8neHotCPQIFGHUx9F0VS6goUNqRj4s31O5T"), true);
    ...
    assert_eq!(xo("E0igebfTclh19OekFu2W1MrD0l5ZpkYPgSNj8wZlz8ujYiTasbP0aSAo5T2wXnO0qbf6v8gF3l3nbbY"), false);
    ...
    assert_eq!(xo("0k6ti2SILoj94L80KmQU kpfm6c5MIIV1EN6xQWeUL0n 7bocNDZrX5WGhbWV4gPvrTHW"), true);
    ...
    assert_eq!(xo("6r9V6I7KyBfH6TCtFvoa4P6MXmjhY90mw7p7RtAU2NfVz8M6z8usI0qjmjT4dEkfb "), true);
    assert_eq!(xo("2RXbvIPu1T6CM229bM9DgfiymIvD6BXXhTiOwHHMsOA9  7Ch4bQtRTEq2t6S"), false);
    ...
    assert_eq!(xo("cNfYXMwA0CPUIIVMk51L75L UyazLIjwxEUtkYGghjCNNUAuQQVczEV"), false);
    ...
    assert_eq!(xo("z05ewFSDZD 98KRjYvjWiSDVk7rMzy0At3ArYfFgMrdVXFqh0kGu2l2od36R86yqCH"), true);
    assert_eq!(xo("h5HQKZAEQjQHhLczOAaHNwAj9Rc9f09E2F5IcY0VXQQ0pVlKnQbaW7  mZbSHcrI8"), true);
    ...
    assert_eq!(xo("1oClzbMm6lWO DriXG PmmZ VUVIQ0ykyNUnsvCtSdAeMFiIzUoL82oKn3h1Ml"), false);
    assert_eq!(xo("6uAkh8rzIh3Pe"), true);
    assert_eq!(xo("LPBfHEoUAB5QrLkzCdnvQDlR61KBnLltjyl8UnWodvIfeMYN05o Y 4QjIdDgWKTY8Wrv5pIhKChRh"), false);
    assert_eq!(xo("Eod3FPZr2kfWYHp0dyQfQzv8YeHVY4Bqw81GIOLbN5MlP7kXwH6 qkb"), false);
    assert_eq!(xo("zwj16tN7wFSOsl70dClXHUWKgbodGEH7T8X wYxqo5PzfRzbgOu5uIAl7KROssEFodei"), false);
    assert_eq!(xo("vi2kGoWomBv94jr McvT14Fwvl"), false);
    assert_eq!(xo("IldhFkt48dzySimI9DAn 8X6CAOX9M2RiwKXlCDh78lIeKtqxHm"), false);
    ...
    assert_eq!(xo("YHprSAYjd3uXufQ6aINqUaqGLdPPXDugkfk3BVo0FgKZWpFPG AsIO1kCQ2T"), true);
    ...
    assert_eq!(xo("zACeQUj9nPUvW3oKXQ1hwEOFCgMxjNMOmIPNyNVRnkNNi8T3vxynCDqY2NMuSSD0afBg"), true);
    ...
    assert_eq!(xo("Y6BeLcu1O5oswydhdaqBkH6VWsrFmxD4h 76ZeVz53W46FioMy4tVM1gq41msRzn5flFft6"), false);
    assert_eq!(xo("5c9B0r6VpMM4FGySU6wHmlrlTc7LmMBka"), true);
    assert_eq!(xo("tiC953BZCmvNw2XqIikAmX5zQzodIj7SnHPjIc0xXzoZs1LK90jbKa"), false);
    assert_eq!(xo("oQBc0thO 6oHREDVd736yZAXKI9ejuKnTEZWT8e63oOvAdoBuwKaLl3mMMmy6iQmIp2"), false);
    assert_eq!(xo("u2790TcAGQvC r4oxVTpA6dRqD4IVZO1PTMIqoiDUEn9UjuMeS9AUayTC8w"), false);
    ...
    assert_eq!(xo("MjvzcgkTQvv93MgDUN56  Is7 3cnt1gcdTHmVs1iTV8cqP1MRCv4"), true);
    ...
    assert_eq!(xo("R H bDLqGPs Dtd UPaEjMILS0 3Rg 9C j w9iHUjtalj3MNwkt1B  Vy"), true);
    ...
    assert_eq!(xo("mCLe4YbTGvRVNq z6 twR6NzZGz RRr2hC3 jhD6AuG udZ0SC9iHVnmmGT5pYZnlAT"), true);
    assert_eq!(xo("1uQ dt1jjUg4ld978vzvwVjpl9UI qunyTNk SY1i Km5Gz2wSgq"), true);
    assert_eq!(xo("WpH Gh9Dz LM qvLRdMd4duIT7Ui YEP"), true);
    assert_eq!(xo("p0lv67FhFEcSMrtq3j2ecnUh4Sbmy6rd5z Mffe1FbWQ TQjCkltGBz"), true);
    ...
    assert_eq!(xo("EADmKaarBNZFuddycjKQrwUq8YcY3aczC0KWi2R3GfUVbZML8U 9ID0RplqqWvkgz9F M lEz"), true);
    assert_eq!(xo("hHRtbQ E uubPfGPs 5E fQ9Dhi5LnG6ya8 AU40D0vsaeCv FMW2gnEETcp5qe"), true);
    ...
    assert_eq!(xo("fFcAu6g TwI2 zfZGR6aynlkPCk8gRiQuWrdchcNg4GDa2vMzk9mDgHf06pf jDYHFZq4tNi6RLyc"), true);
    ...
    assert_eq!(xo("1ceK5NLUzlygI4 QQp0PjrhTGkhfrLs4rs 98hEjUYRr DRM Wb9TPQp2Hv4mYVWGz"), true);
    assert_eq!(xo("DIM4rvvi 8  Gw5DTTtFvLqhiRqIak7BN F2u97N4YbIUhpe fHy5GlwplUzIWtv"), true);
    ...
    assert_eq!(xo("  9EG  t0jlC8haCM1ics 1L1e gtggRSa6kZrzLk EhVA9Amy6PMZkHC 5BBu"), true);
    ...
    assert_eq!(xo("B2 gQr d niZgL1KLERlD jr1B1Syps39CymNE h2G9rbVZrhfz2c 3pvK mN6jBH"), true);
    assert_eq!(xo("aENLLFbFK n CADtW7Dzu9q1cNZA  5L4K  cBfqTAmjaqlD865w25MfHIVj7K7MnvnKi KS u1zy"), true);
    ...
    assert_eq!(xo("MI3Els GtA3KCdETza 6j  sWMPVEQik90LgpM4f C3s6zFhR7 LeE4"), true);
    assert_eq!(xo("jWgK2c7MzGe R6A5GErICGCfP56ScMi kc"), true);
    assert_eq!(xo(" Gf7719  26dYvfyi11  Ljrwr P"), true);
    assert_eq!(xo("Q2ntelq3j dufvSP GGmR9Nad2dh0VTnD4EGdQU VKY8riTPVs9giVmzAAYIbw705bStMaT "), true);
    ...
    assert_eq!(xo(" jn8I iHpvU2K5ftr r4EmF2M6IdR mD BIyvHCEqzlKfTVgMB zdV 0HHs 0PZYvlAL7 a7AWSB9n"), true);
    assert_eq!(xo("Cppez5plIBQHVqnjvFMePadYCD IARP AKb5AYa"), true);
    assert_eq!(xo("zSVtPal5N 5nly3wL0PzQ ArM98mW Y LlNj tagdePRiQYM tuMdL30HNv"), true);
    assert_eq!(xo("542PpD1PK9V5qcvuV16a3e0eL1evFnEIhlub678D3KT1q27VH"), true);
    ...
    assert_eq!(xo("8kR 9V0DUB2gsBs7pEV 5tj0R2HUgPKsMs6C65mEKgG2qNBpkURaALpt BAVcl8pQ45bCkNEY"), true);
    ...
    assert_eq!(xo("cvH6Epcm6D 2qFa Ez tth WGVug8u0l Ds4BYkH bT wGWR94UruGECmI8vF5DtI"), true);
    assert_eq!(xo("6zzd0Q R Iiqwy4Iu0sPZI F6V YNylZnA5ceQMS"), true);
    assert_eq!(xo("5S80EEt FFidVVyYz ln30VE4iYz5ukNHgCiGMUzQGEsmUKLu8t981 167pBqn HPlBh"), true);
    assert_eq!(xo("lYU6qZ TnqAvtIz39iC3hY3DyIdnzQRA9wU7LMmi19E3Y ZW2RluwaLtH5 0z5 h5upS6IKZUaPw3zWLB NV6RM vh"), true);
    assert_eq!(xo("Hau4earFrAvC Rc cFPrm Maf 0CFgllnvdnYhrU1bl8MDyakGfK8r2pcN50e"), true);
    ...
    assert_eq!(xo("MkfgABfjI7NFD3ljb ZQHDcbu7 kDt2 crD5N1avV79bMgAa0 AG76qeM lWRp1NaEL0k2crBlnPYq"), true);
    ...
    assert_eq!(xo("5 p 73kd I0AG Fnyfd4  KrSrpeZftSAs Iwq IILagNVP2qV  t sHElLsR Cr4TA5E EeqAjVbN"), true);
    ...
    assert_eq!(xo("9pv4pI BVpwgYwI 91hKy pFdrygs4eiemqs6 7Hk85N9 Y5jZAzwZ9gVw"), true);
    ...
    assert_eq!(xo("SN34S 7MU4smmFNzQZpflCcYlzdTL3zlHssk5utQ0hNv4SGlvV"), true);
    assert_eq!(xo("SIMp1 zzNsPi1 jyF pykn4FhRzUNtq SMU 91KVqk21w 6GWeL  Pv"), true);
    assert_eq!(xo("tDa1Kajz9NK5SnFSFY DS"), true);
    assert_eq!(xo("zeb0 C unA YQQGHZDR UtBsKmGyekmz  ztY3s3W4m4 t rGwWdtfcZSwNSlf7P9hDRyV UG"), true);
    ...
    assert_eq!(xo("iibvLd4Hdnaj0vrEd738L9I6g5dHyERdPMYjeb5gVyWZQEdSmeUywy9f8a2wDvfssLQsrv"), true);
    ...
    assert_eq!(xo("Zdqt7tbGf7np9f8LzmK2zw ZEKCYS9 c UmtA KBHu7Dk4zIz"), true);
