...
///
/// Write a function cakes(), which takes the recipe (HashMap<&str, u32>) and
/// the available ingredients (also a HashMap<&str, u32>) and returns
/// the maximum number of cakes Pete can bake (u32).
...
///
/// // must return 2
/// cakes(HashMap::from([("flour", 500), ("sugar", 200), ("eggs", 1)]),
///       HashMap::from([("flour", 1200), ("sugar", 1200), ("eggs", 5), ("milk", 200)]))
///
/// // must return 0
/// cakes(HashMap::from([("apples", 3), ("flour", 300), ("sugar", 150), ("milk", 100), ("oil", 100)]),
///       HashMap::from([("sugar", 500),("flour", 2000), ("milk", 2000)]))
///
/// ## What I learned
///
/// -
...
fn cakes(recipe: &HashMap<&str, u32>, available: &HashMap<&str, u32>) -> u32 {
    recipe.iter().fold(u32::MAX, |accu, (k, v)| {
        let Some(q) = available.get(k) else {
            return 0;
        };
        if q < v {
            return 0;
...
fn _cakes_v1(recipe: &HashMap<&str, u32>, available: &HashMap<&str, u32>) -> u32 {
    recipe.iter()
